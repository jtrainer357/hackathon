...
const filterTabs: { value: ConversationFilter; label: string; icon?: React.ReactNode }[] = [
    ...
    { value: 'flagged', label: 'Flagged', icon: <Flag02Icon className="h-3.5 w-3.5" /> },
...
const channelTabs: { value: MessageChannel | undefined; label: string; icon: React.ReactNode }[] = [
    ...
    { value: 'sms', label: 'SMS', icon: <Message01Icon className="h-4 w-4 text-growth-3" /> },
    { value: 'email', label: 'Email', icon: <Mail01Icon className="h-4 w-4 text-vitality-2" /> },
    { value: 'voice', label: 'Voice', icon: <Mic01Icon className="h-4 w-4 text-synapse-5" /> },
]
        ...
        <div className="flex flex-col h-full bg-background">
            ...
            <div className="p-3 md:p-4 border-b border-border">
                <div className="relative">
                    <SearchList01Icon className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                    <Input
            ...
            <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-1.5 mt-1.5">
                    ...
                    {conversation.isFlagged && (
                        <Flag02Icon className="h-3.5 w-3.5 text-vitality-1" />
                    )}
                </div>
            </div>
        </button>
