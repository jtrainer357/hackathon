...
import { Card, CardContent, CardHeader } from "@/components/v2/molecules/card"
...
export function WidgetContainer({
    ...
    return (
        <Card className={cn("border-none shadow-widget h-full flex flex-col overflow-hidden py-0", variantStyles[variant], className)}>
